...
namespace PEPerez.DungeonPainter.Runtime
{
    public class DungeonGenerator : MonoBehaviour
    {
        ...
        private Transform GetContainter(string name)
        {
        ...
        private void PlacePrefabs(PlacebleSet set, string containerName)
        {
            ...
            { 
                ...
                for (int x = 0; x < tileCountY; x++)
                {
                    for (int z = 0; z < tileCountY; z++)
                    {
                        ...
                        tile = Instantiate(set.Prefabs[Random.Range(0, set.Prefabs.Count)]);
                            ...
                            tile.transform.SetParent(GetContainter(containerName));
                        }
                ...
                //check to see if pioint is contained in any room
